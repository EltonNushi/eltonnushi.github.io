...
// =========================================================================
// 🔒 DYNAMIC CORS REFLECTOR FIREWALL (UNBLOCKS SAFARI/WEBKIT PERMANENTLY)
// =========================================================================
    ...
    try {
        ...
        if (typeof bodyPayload === 'string') {
            try { bodyPayload = JSON.parse(bodyPayload); } catch (e) {
                ...
                if (match && match[1]) targetTenant = match[1];
            }
        }
        ...
        if (typeof input === 'string') {
            try { input = JSON.parse(input); } catch(e) {
                ...
                input = {
                    ...
                    resDate: dateMatch ? parseFloat(dateMatch[1]) : Date.now(),
